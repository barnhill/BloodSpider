    ...
    public partial class Contact : Page
    {
        ...
        protected void btnSendEmail_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Submit)
                {
                    MailMessage msg = new MailMessage(this.txtEmailAddress.Text.Trim(), ConfigurationManager.AppSettings["WebmasterEmail"].Trim(), "[BloodSpider WEBSITE]", this.txtMessage.Text.Trim());
