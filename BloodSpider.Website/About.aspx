<%@ Page Title="In the Beginning" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="BloodSpider.Website.About" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div style="background-image:url('Images/about/about.jpg'); background-repeat:no-repeat; background-position:bottom; height:430px;">
        <div style="width:570px; padding:20px 0px 0px 0px;">
            ...
            <article>        
                <p>        
                    BloodSpider was dreamed up while watching a few diabetics suffer though the monotony of recording their glucose readings in a logbook or a cumbersome piece of software that required manual entry of the data.  
                    The thought of "there has to be a better way" crossed our minds just like it has so many diabetics in the past.  So in our lab (a home office, coffee shops, and online chats) BloodSpider was born.  
                </p><br />        
                <p>        
