<%@ Page Title="Personal Settings" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PersonalSettings.aspx.cs" Inherits="BloodSpider.Website.Account.PersonalSettings" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:SqlDataSource ID="PersonalSettings_DataSource" runat="server" ConnectionString="<%$ ConnectionStrings:BloodSpiderConnectionString %>" SelectCommand="sp_GetUserSettings" SelectCommandType="StoredProcedure" >
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="UserType_DataSource" runat="server" ConnectionString="<%$ ConnectionStrings:BloodSpiderConnectionString %>" SelectCommand="sp_GetAllUserTypes" SelectCommandType="StoredProcedure" />
    <asp:SqlDataSource ID="TimeZones_DataSource" runat="server" ConnectionString="<%$ ConnectionStrings:BloodSpiderConnectionString %>" SelectCommand="sp_GetAllTimezones" SelectCommandType="StoredProcedure" />
    <asp:SqlDataSource ID="DiabetesTypes_DataSource" runat="server" ConnectionString="<%$ ConnectionStrings:BloodSpiderConnectionString %>" SelectCommand="sp_GetAllDiabetesTypes" SelectCommandType="StoredProcedure" />
    <br />
