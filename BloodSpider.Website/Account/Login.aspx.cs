...
namespace BloodSpider.Website.Account
{
    public partial class Login : Page
    {
        ...
        {
            HttpCookie authCookie = Request.Cookies[BloodSpider.Services.Common.Statics.AuthenticationCookie];
            ...
            if (authCookie != null && !string.IsNullOrEmpty(authCookie.Value))
            {
                ...
                {
                    this.LoginContainer.UserName = BloodSpider.Services.Common.StringCipher.Decrypt(authTicket.Name, true);
