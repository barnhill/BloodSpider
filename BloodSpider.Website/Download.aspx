<%@ Page Title="Free BloodSpider Download" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Download.aspx.cs" Inherits="BloodSpider.Website.Download" %>
    ...
    <div style="padding-top:20px; height:320px;">   
        <div style="float:left; width:500px;">
            ...
            <div style="text-align: center; width: 250px;">
                <a href="/download/BloodSpider_Windows_Setup.exe"><img src="Images/download/download.png" /></a><br />
                <asp:Label ID="lblWinVersion" runat="server" Text="[Windows Version]"/><br /><br />
            </div><br />       
            <a href="About.aspx">What is BloodSpider?</a><br />
